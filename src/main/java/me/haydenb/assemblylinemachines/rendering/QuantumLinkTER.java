...
@OnlyIn(Dist.CLIENT)
public class QuantumLinkTER extends TileEntityRenderer<TEQuantumLink> {
	...
	public QuantumLinkTER(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}
	public void render(TEQuantumLink tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
	...
	private void renderCube(TEQuantumLink tileEntityIn, float p_228883_2_, float p_228883_3_, Matrix4f p_228883_4_, IVertexBuilder p_228883_5_) {
		...
		this.renderFace(tileEntityIn, p_228883_4_, p_228883_5_, MIN, MAX, MIN, MAX, MAX, MAX, MAX, MAX, f, f1, f2, Direction.SOUTH);
		this.renderFace(tileEntityIn, p_228883_4_, p_228883_5_, MIN, MAX, MAX, MIN, MIN, MIN, MIN, MIN, f, f1, f2, Direction.NORTH);
		this.renderFace(tileEntityIn, p_228883_4_, p_228883_5_, MAX, MAX, MAX, MIN, MIN, MAX, MAX, MIN, f, f1, f2, Direction.EAST);
		this.renderFace(tileEntityIn, p_228883_4_, p_228883_5_, MIN, MIN, MIN, MAX, MIN, MAX, MAX, MIN, f, f1, f2, Direction.WEST);
		this.renderFace(tileEntityIn, p_228883_4_, p_228883_5_, MIN, MAX, MIN, MIN, MIN, MIN, MAX, MAX, f, f1, f2, Direction.DOWN);
		this.renderFace(tileEntityIn, p_228883_4_, p_228883_5_, MIN, MAX, MAX, MAX, MAX, MAX, MIN, MIN, f, f1, f2, Direction.UP);
	}

	private void renderFace(TEQuantumLink tileEntityIn, Matrix4f p_228884_2_, IVertexBuilder p_228884_3_, float p_228884_4_, float p_228884_5_, float p_228884_6_, float p_228884_7_, float p_228884_8_, float p_228884_9_, float p_228884_10_, float p_228884_11_, float p_228884_12_, float p_228884_13_, float p_228884_14_, Direction p_228884_15_) {
