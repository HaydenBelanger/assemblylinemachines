...
public class AlloyingCrafting implements Recipe<Container>, IRecipeCategoryBuilder{
	...
	public static final RecipeType<AlloyingCrafting> ALLOYING_RECIPE = new RecipeType<>() {
		@Override
	...
	public static class AlloyingSerializer implements RecipeSerializer<AlloyingCrafting>{
