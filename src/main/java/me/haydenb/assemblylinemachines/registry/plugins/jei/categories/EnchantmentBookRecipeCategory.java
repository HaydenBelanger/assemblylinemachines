...
public class EnchantmentBookRecipeCategory implements IRecipeCategory<EnchantmentBookCrafting> {
	...
	public Component getTitle() {
		return new TextComponent("Enchantment Crafting");
	}
	...
	@Override
	public void draw(EnchantmentBookCrafting recipe, PoseStack mx, double mouseX, double mouseY) {
	...
	public void setIngredients(EnchantmentBookCrafting recipe, IIngredients ingredients) {
		...
		for(ItemStack ig : recipe.getIngredients().get(1).getItems()) {
