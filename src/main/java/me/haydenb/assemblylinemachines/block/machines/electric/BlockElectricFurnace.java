...
public class BlockElectricFurnace extends GUIContainingBasicBlock<BlockElectricFurnace.TEElectricFurnace>{
	...
	public static class TEElectricFurnace extends ALMManagedSidedMachineBlock<ContainerElectricFurnace> implements ITickableTileEntity{
	...
	public static class ContainerElectricFurnace extends ContainerALMBase<TEElectricFurnace>{
		...
		public ContainerElectricFurnace(final int windowId, final PlayerInventory playerInventory, final TEElectricFurnace tileEntity) {
			...
			this.addSlot(new AbstractALMMachine.SlotWithRestrictions(this.tileEntity, 1, 75, 34, tileEntity));
		...
		public ContainerElectricFurnace(final int windowId, final PlayerInventory playerInventory, final PacketBuffer data) {
			this(windowId, playerInventory, Utils.getTileEntity(playerInventory, data, TEElectricFurnace.class));
		}
	}
